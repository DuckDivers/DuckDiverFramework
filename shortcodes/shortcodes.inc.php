<?php //include bootstrap shortcodes

	include_once ('columns.php');
	include_once ('shortcodes.php');
	include_once ('posts-grid.php');
	include_once ('posts-list.php');
	include_once ('mini-posts-list.php');
	include_once ('mini-posts-grid.php');
	...
	include_once ('hero-unit.php');
	include_once ('roundabout.php');
