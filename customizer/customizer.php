...
$options[] = array(
	'title'             => __( 'Mobile Color Theme', 'dd_theme' ),
...
$options[] = array(
	'title'          => __( 'Google Analytics', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Analytics Code', 'dd_theme' ),
...
$options[] = array(
	'title'          => __( 'Slider Options', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Slider Active', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Slider Delay', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Slider Transition', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Disable Slide Post Type', 'dd_theme' ),
...
$options[] = array(
	'title'          => __( 'Theme Options', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Search in Menu', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Search in Header', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Global Messsage', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Exclude Fontawesome', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Include Magnific Popup', 'dd_theme' ),
	'description'       => __( 'Check this box to INCLUDE Magnific Popup', 'dd_theme' ),
	'section'           => 'dd_theme_options',
...
$options[] = array(
	'title'             => __( 'Sidebar Position', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Shop Sidebar Position', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Hide Sidebar on Product Page?', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Hide Sidebar on Shop Archive Pages?', 'dd_theme' ),
...
$options[] = array(
	'title'          => __( 'Blog Options', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Default Image', 'dd_theme' ),
	'description'       => __( 'Select the default image if there is no featured image or an image in the post to use.', 'dd_theme' ),
	'section'           => 'dd_blog_options',
	'id'                => 'dd_default_blog_image',
	'option'            => 'image',
	'sanitize_callback' => 'esc_url',
	'type'              => 'control',
);
...
$options[] = array(
	'title'             => __( 'Use infinite scroll?', 'dd_theme' ),
	'description'       => __( 'Check this box to use infinite scroll on the blog page.', 'dd_theme' ),
	'section'           => 'dd_blog_options',
	'id'                => 'dd_use_infinite_scroll',
	'default'           => '',
	'option'            => 'checkbox',
	'sanitize_callback' => '',
	'type'              => 'control',
...
$options[] = array(
	'title'             => __( 'Blog Featured Image', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Blog Excerpt Length', 'dd_theme' ),
	'description'       => '',
	'section'           => 'dd_blog_options',
...
$options[] = array(
	'title'             => __( 'Read More Text', 'dd_theme' ),
...
$options[] = array(
	'title'             => __( 'Single Post Featured Image', 'dd_theme' ),
